...
* Hide views and likes: turns view-count and like-count text hiding on or off.
...
Hide views and likes uses YouTube DOM/CSS selectors plus conservative text and ARIA relation checks. New YouTube count surfaces may require selector updates.

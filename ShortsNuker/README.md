...
Settings persist through Chrome extension storage. Default states are Remove Shorts on, Strict Search Title Match on, Theme Color Test off, and Theme Surface Test off.
